 ...
 */
@Mapper
public interface IUserBindingDao extends BaseMapper<UserBindingPO> {
    ...
    UserBindingPO findByIdentityTypeAndIdentifier(@Param("identityType") String identityType, @Param("identifier") String identifier);
    ...
    UserBindingPO findByUserIdAndIdentityType(@Param("userId") Long userId, @Param("identityType") String identityType);
