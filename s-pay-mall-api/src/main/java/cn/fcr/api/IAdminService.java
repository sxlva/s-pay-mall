...
public interface IAdminService {
     ...
     * @return 用户列表
     */
    Response<List<Map<String, Object>>> listUsers(String username, Integer status, String roleCode);
     ...
     * @return 成功返回影响行数
     */
    Response<Integer> saveUser(UserSaveRequest request);
     ...
     * @return 成功返回影响行数
     */
    Response<Integer> saveCategory(CategorySaveRequest request);
     ...
     * @return 订单列表
     */
    Response<List<Map<String, Object>>> listOrders(
            Long userId,
            String status,
            String startTime,
            String endTime);
     ...
     */
    Response<List<Map<String, Object>>> getSalesTrend();
     ...
     */
    Response<List<Map<String, Object>>> getCategoryRatio();
}